...
*En variables instrumentales utilizamos el programa "ivreg2".
*Dado que el paquete básico de Stata no contiene el comando "ivreg2" es necesario instalarlo:

**** Instalación "ivreg2"
net from http://fmwww.bc.edu/RePEc/bocode/i
net install ivreg2, replace

*Así como algunos paquetes adicionales
* "ranktest"
ssc install ranktest

* "overid"
net from http://www.stata-journal.com/software/sj7-4
net install st0030_3, replace 
