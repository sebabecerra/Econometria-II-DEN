...
* 3. Wald IV as Twostage least squares
regress educ  nearc4, robust
predict shat

regress lwage  shat, robust
gen wald_2sls1 = _b[shat]


* 4. Wald IV as Twostage least squares
ivregress 2sls lwage (educ=nearc4), first robust
gen wald_2sls2 = _b[educ]
